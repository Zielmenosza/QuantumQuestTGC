...
import com.example.quantumquest.activities.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadGameAssets(() -> {
            ...
            videoView.setOnCompletionListener(mp -> {
                ...
                Intent intent = new Intent(VideoActivity.this, com.example.quantumquest.activities.MainActivity.class);
